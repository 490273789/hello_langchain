...
class SearchSubAgent:
    ...
    def __init__(self):
        ...
        self.agent = create_agent(model=ds, tools=self.tools)
    ...
    async for chunk in supervisor_agent.astream(
        {
            "messages": [
                ...
                {
                    "role": "user",
                    "content": "北京明天天气怎么样，要是还不错的话，帮我看看明天从龙跃苑三区到北发大厦怎么走最快。如果天气好的话，发送邮件给snpro@qq.com告诉他我明天去北京。如果天气不好的话就告诉他我明天不去北发大厦了。要告诉邮件是否发送成功",
                },
            ]
        }
    ):
